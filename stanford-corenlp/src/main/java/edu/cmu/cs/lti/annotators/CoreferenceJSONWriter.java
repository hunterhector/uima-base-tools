                    ...
                    if (tokenSpan.getBegin() < numTokenInTitle) {
                        ...
                        if (tokenSpan.getEnd() > numTokenInTitle) {
                            ...
                            if (addTitlePortion) {
                                ...
                                JsonEntityMention jsonTitleMention = new JsonEntityMention();
                                jsonTitleMention.surface = titleMention.getCoveredText();
                                jsonTitleMention.loc.add(titleTokenSpan.getBegin());
                                jsonTitleMention.loc.add(titleTokenSpan.getEnd());
                                jsonTitleMention.head = UimaNlpUtils.findHeadFromStanfordAnnotation(titleMention)
                                        .getIndex();
                                jsonTitleMention.source = "title";
                                jsonEntity.mentions.add(jsonTitleMention);
                            }
