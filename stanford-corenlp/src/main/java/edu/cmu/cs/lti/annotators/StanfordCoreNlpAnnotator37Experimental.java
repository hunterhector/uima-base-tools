...
// * @author Da Teng
// */
//public class StanfordCoreNlpAnnotator37Experimental extends AbstractLoggingAnnotator {
...
//
//    public static final String PARAM_COREF_ALGORITHM = "corefOption";
//    @ConfigurationParameter(name = PARAM_COREF_ALGORITHM, mandatory = false)
//    private String corefAlgorithm;
//
...
//            }
//
//            if (corefAlgorithm != null) {
//                logger.info("Coreference option is set to " + corefAlgorithm);
//                props.setProperty("coref.algorithm", corefAlgorithm);
//            }
//
//            if (numThreads > 1) {
...
//        int characterId = 0;
//        for (CoreLabel character : document.get(SegmenterCoreAnnotations.CharactersAnnotation.class)) {
