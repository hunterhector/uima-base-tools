...
public class TimeSortedXmiCollectionReader extends AbstractCollectionReader {
    ...
    public boolean hasNext() {
        return mCurrentIndex < files.size();
    }
    ...
    public void getNext(JCas jCas) throws IOException, CollectionException {
        File currentFile = (File) files.get(mCurrentIndex++);
    ...
    public Progress[] getProgress() {
        return new Progress[]{new ProgressImpl(mCurrentIndex, files.size(), Progress.ENTITIES)};
    }
