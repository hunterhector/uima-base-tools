...
public class TagmeStyleJSONReader extends JCasCollectionReader_ImplBase {
    ...
    public static final String PARAM_ABSTRACT_FIELDS = "abstractFields";
    @ConfigurationParameter(name = PARAM_ABSTRACT_FIELDS)
    ...
    public void getNext(JCas jCas) throws IOException, CollectionException {
        ...
        JsonArray salienceSpots = allSpots.get(salienceText).getAsJsonArray();
