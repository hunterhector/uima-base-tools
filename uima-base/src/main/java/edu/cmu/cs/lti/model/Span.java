...
public class Span implements Comparable<Span> {
    ...
    /**
     * I first implemented this in a way that earlier Spans are larger, this might be counter-intuitive, however, this
     * code is used in multiple places so it is not very easy to chagne the behavior and refactor correctly.
     *
     * @param thatSpan
     * @return
     */
